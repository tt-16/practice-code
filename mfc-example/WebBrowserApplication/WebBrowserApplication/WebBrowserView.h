...
// 属性
public:
	CWebBrowserApplicationDoc* GetDocument() const;
...
inline CWebBrowserApplicationDoc* CWebBrowserView::GetDocument() const
   { return reinterpret_cast<CWebBrowserApplicationDoc*>(m_pDocument); }
#endif
