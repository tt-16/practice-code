...
// webbrowsertestView.cpp : CwebbrowsertestView 类的实现
//
...
CwebbrowsertestDoc* CwebbrowsertestView::GetDocument() const // 非调试版本是内联的
{
