...
echo $POINT_NUM
#GsFile="/wrf/LIBRARIES/WindFarmConfigT/$CPName/grads-2.1.a3/bin/wg.gs"
GsFile="./wg.gs"
...
echo "'open /wrf/LIBRARIES/RESULT/$CPName/20150716/test.ctl'" >> $GsFile

echo "'set gxout print'" >> $GsFile
echo "filename = \"out.txt\"" >> $GsFile
echo "rc = write(filename, \"\")" >> $GsFile
echo "rc = write(filename,\"lon_lat:$LON_LAT\")" >> $GsFile
